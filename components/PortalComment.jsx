                        ...
                        <div className="d-flex comment__wrap-content">
                          ...
                          <div className="d-flex flex-column flex-grow-1">
                            <div className="d-flex align-items-center justify-content-between">
                              ...
                              <div>
                                <button className="btn__reply" onClick={handleClickReply}>
                                  <i
                                    data-id={comment.commentId}
                                    className="fas fa-comment fa__reply"
                                  ></i>
                                </button>
                                <button className="btn__reply" onClick={handleClickPrivateMessage}>
                                  <i
                                    data-id={comment.commentId}
                            ...
                            {comment.photo && (
                              <div className="post__photo">
                                <img src={comment.photo} width="50%" />
                              </div>
                            )}
                        ...
                        <div className="reply__comment">
                          {comment.replies &&
                            comment.replies.map(parseComment).map((reply) => {
                              return (
                                <div key={reply.commentId} className="d-flex comment__wrap-content">
                                  <div className="symbol symbol-60 symbol-2by3 flex-shrink-0 mr-4">
                                    <div
                                      className="symbol-label avatar"
                                      style={{
                                        backgroundImage: "url(" + reply.imgUrl + ")",
                                      }}
                                    ></div>
                                  </div>
                                  <div className="d-flex flex-column flex-grow-1">
