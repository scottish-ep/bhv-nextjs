...
const ModalUnblockCustomer = (props: UnblockCustomerProps) => {
  const {
    isVisible,
    title,
    iconClose = 'Đóng',
  ...
  return (
    ...
    >
      <div className="flex justify-center w-full bg-white text-medium font-medium my-[48px]">
        Bạn có chắc chắn muốn bỏ chặn khách hàng này không?
      </div>
      <div className="flex justify-between">
        <Button variant="outlined" width={220} height={55} text="HUỶ BỎ" onClick={onClose}/>
        <Button variant="secondary" width={220} height={55} text="BỎ CHẶN" onClick={onOpen}/>
      </div>
    </Modal>
  );
};
export default ModalUnblockCustomer;