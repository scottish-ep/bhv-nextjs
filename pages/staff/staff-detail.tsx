...
const StaffDetail = () => {
  ...
  const columns: ColumnsType<ITartgetManageProps> = [
    {
      ...
      render: (_, record) => {
        return (
          <p className="text-medium font-medium">{record.month}</p>
        )
      }
    },
    {
  ...
  const columns2: ColumnsType<IFaultDetailProps> = [
    {
      ...
      render : (_, record)  => {
        return (
          <p className="font-medium  text-medium">{record.name}</p>
        )
      }
    },
    {
      ...
      render : (_, record)  => {
        return (
          <p className="font-medium  text-medium">{record.fault}</p>
        )
      }
    },
    {
      ...
      render : (_, record) => {
        return (
          <p className="font-normal text-medium">03/10/2022 09:25</p>
        )
      }
    },
    {
  ...
  return (
      <div className="w-full p-[12px] bg-gray-100 rounded-lg staff-detail">
          <TitlePage title="Quản lý chỉ tiêu" href="/user-goal" className="mb-[12px] "/>
          <div className="flex justify-between mb-[12px] mt-[12px] ">
            <div className="flex flex-col bg-white rounded-lg p-[12px] w-[516px]">
              ...
              <div className="flex justify-start items-center mb-[12px] items-center">
                <p className="mr-[85px] text-medium font-medium text-[#EF4444]">Chặn nhân viên này</p>
                <Switch/>
              </div>
            </div>
            <div className="flex flex-col w-[790px]">
              ...
              <div className="flex justify-start my-[8px]">
                ...
                <p className="text-medoium font-medium text-[#384ADC] mr-[5px]">1500</p>   
                <p>|</p>
                <p className="text-medoium font-medium mx-[5px]">Tổng doanh thu:</p>
                <p className="text-medoium font-medium text-[#384ADC] mr-[5px]">160.500.000 đ</p> 
              </div>
              <div className="bg-white flex flex-col p-[12px]">
                <div className="w-full">
                  <div className="flex justify-between w-full mb-[12px] items-center">
                    ...
                    <Button variant="outlined" width={114} height={45} icon=  {<Icon icon="add-1" size ={24}/>} text="Thêm lỗi"/>
                  </div>
