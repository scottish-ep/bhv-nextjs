...
interface BalanceWareHouseFormProps {
  detail?: IWareHousesDetail;
}

const BalanceWareHouseForm: React.FC<BalanceWareHouseFormProps> = ({
  detail,
}) => {
  return (
    <div className="w-full">
      ...
      <div className="flex gap-x-3">
        ...
        <div className="flex flex-col justify-between gap-y-4 bg-white flex-1 p-3 rounded h-max">
          <Select
            label="Chọn kho kiểm"
      ...
      {/* Table */}
      <BalanceWareHouseFormTable product_list={detail?.product_list} />
    </div>
  );
};

export default BalanceWareHouseForm;
