...
const BalanceWareHouseList = () => {
  ...
  //       setBalanceWareHouses(customers);
  //       setLoading(false);
  //     })
  //     .catch((err) => {
  //       console.log(err);
    ...
    <div className="w-full">
      ...
      <div className="flex items-center flex-wrap gap-[8px] mb-[12px]">
        <Input
          ...
          placeholder="Nhập mã phiếu cân bắng kho"
        />
        <Input
          width={306}
      ...
      <ModalRemove
        ...
        titleBody="Xoá phiếu cân bắng kho?"
        content="Thông tin của phiếu cân bằng kho sẽ không còn nữa."
      />
    </div>
  );
};
