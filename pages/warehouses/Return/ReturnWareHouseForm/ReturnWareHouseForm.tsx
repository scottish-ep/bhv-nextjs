...
import ReturnWareHouseFormTable from "./ReturnWareHouseFormTable";

interface ReturnWareHouseFormProps {
  detail?: IWareHousesDetail;
}

const ReturnWareHouseForm: React.FC<ReturnWareHouseFormProps> = ({
  detail,
}) => {
  return (
    <div className="w-full">
      ...
      <div className="flex justify-between mb-5">
        <TitlePage
          href="/warehouse/return-commands"
          title={detail ? "Chi tiết phiếu trả hàng" : "Tạo phiếu trả hàng"}
        />
      ...
      {/* Table */}
      <ReturnWareHouseFormTable product_list={detail?.product_list} />
    </div>
  );
};

export default ReturnWareHouseForm;
